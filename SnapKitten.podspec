...
Pod::Spec.new do |s|
  s.name             = 'SnapKitten'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SnapKitten.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Spring Wong/SnapKitten'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Spring Wong' => 'rudolphwong2002@gmail.com' }
  s.source           = { :git => 'https://github.com/Spring Wong/SnapKitten.git', :tag => s.version.to_s }
